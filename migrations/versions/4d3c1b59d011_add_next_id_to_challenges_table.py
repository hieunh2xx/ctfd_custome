...
def upgrade():
    ...
    # op.add_column("challenge", sa.Column("isDeploy", sa.Boolean(), nullable=False))
    # op.create_table(
    #     "deployed_challenge",
    #     sa.Column("id", sa.Integer(), primary_key=True),
    #     sa.Column("challenge_id", sa.Integer(), nullable=False),
    #     sa.Column("deploy_state", sa.NVARCHAR(50), nullable=True),
    #     sa.Column("image_name", sa.NVARCHAR(128), nullable=True),
    #     sa.Column("last_update", sa.DateTime(), nullable=True),
    #     sa.Column("time_limit", sa.DateTime(), nullable=True),
    # )
